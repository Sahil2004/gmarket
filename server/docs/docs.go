...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "1d",
                        "description": "Chart Range (e.g., 1d, 5d, 1mo)",
                        "name": "range",
                        "in": "query",
                        "required": true
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dtos.MarketDepthDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/watchlists/{watchlist_idx}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Watchlist Index (1-10)",
                        "name": "watchlist_idx",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dtos.WatchlistDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/watchlists/{watchlist_idx}/symbols": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.SymbolDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "dtos.WatchlistDTO": {
            ...
            "properties": {
                ...
                "symbols": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.SymbolInfo"
                    }
                }
            }
        }
